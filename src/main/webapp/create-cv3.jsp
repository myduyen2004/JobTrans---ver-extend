...
<div style="border-radius: 20px; margin-top:40px;padding:30px;border: 1px #0a0a2b solid; margin-left: -19px">
                    ...
                    <div class="cv-main">
                        ...
                        <div style="border-radius: 20px; margin-top:40px;padding:30px;border: 1px solid"
                            ...
                            <h3 s class="main-section-title" id="careerGoalTitle">Mục tiêu nghề nghiệp</h3>
...
<script>
    ...
    function updateTextColor(bgColor) {
        ...
        const brightness = calculateBrightness(bgColor || '#8492a6');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const savedColor = localStorage.getItem('cvBackgroundColor') || '#8492a6';
