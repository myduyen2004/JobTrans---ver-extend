            ...
            <div class="h-100">
              ...
              <div class="row gx-4 gy-4">
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="flex-grow-1 overflow-hidden">
                          <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Công việc đã đăng</p>
                        </div>
                      </div>
                ...
                <span class="avatar-title bg-primary-subtle rounded fs-3">
                    <i class="bx bx-file text-primary"></i> <!-- Icon đại diện -->
                </span>
                          </div>
                ...
                <div class="col-xl-3 col-md-6">
                  ...
                  <div class="card card-animate">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="flex-grow-1 overflow-hidden">
                          <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Công việc hoàn thành</p>
                        </div>
                ...
                <span class="avatar-title bg-success-subtle rounded fs-3">
                    <i class="bx bx-trophy text-success"></i> <!-- Icon đại diện -->
                </span>
                          </div>
                ...
                <div class="col-xl-3 col-md-6">
                  ...
                  <div class="card card-animate">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="flex-grow-1 overflow-hidden">
                          <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Đang làm việc</p>
                        </div>
                ...
                <span class="avatar-title bg-warning-subtle rounded fs-3">
                    <i class="bx bx-hourglass text-warning"></i> <!-- Icon đại diện -->
                </span>
                          </div>
                ...
                <div class="col-xl-3 col-md-6">
                  ...
                  <div class="card card-animate">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div class="flex-grow-1 overflow-hidden">
                          <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Bị khiếu nại </p>
                        </div>
                      </div>
                      <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                ...
                <span class="avatar-title bg-danger-subtle rounded fs-3">
                    <i class="bx bx-error-circle text-danger"></i> <!-- Icon đại diện -->
                </span>
                          </div>
