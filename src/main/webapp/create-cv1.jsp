                        ...
                        <div class="skill-item">
                            ...
                            <div class="form-group">
                                <select class="form-control" name="skillId[]" id="skillSelect">
                                    ...
                                    <c:forEach items="${CVDAO.allMainSkill}" var="o">
                                        <optgroup label="${o.mainSkillName}" data-mainskill="${o.mainSkillId}" class="skill-optgroup">
...
<script>
    ...
    // Lắng nghe sự kiện thay đổi màu từ header
    // Lắng nghe tin nhắn từ parent window (nếu trong iframe)
