                ...
                <div class="contract-section" id="negotiation-section">
                    ...
                    <div class="negotiation-area">
                        <div class="alert alert-info">
                            <p><i class="fas fa-info-circle"></i> Đây là khu vực để hai bên thảo luận và thống nhất các
                                điều khoản trước khi tạo hợp đồng chính thức. Sau khi thỏa thuận xong, các điều khoản sẽ
                                được điền vào mẫu hợp đồng.</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="project-description" rows="3"
                                      placeholder="Yêu cầu chi tiết về chất lượng công việc"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="contract-value"
                        ...
                        <div class="form-group">
                            ...
                            <div id="payment-terms">
                                <div class="payment-term">
                                    <input type="number" class="form-control payment-percent" placeholder="%" min="1"
                                           max="100">
                                    <span>% sau khi</span>
                                    <input type="text" class="form-control payment-condition"
                                           placeholder="điều kiện thanh toán">
                                    <button class="btn btn-sm btn-outline add-payment-term"><i class="fas fa-plus"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control mt-2" id="ip-details" rows="2"
                                      placeholder="Chi tiết về quyền sở hữu trí tuệ"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="additional-terms" rows="4"
                                      placeholder="Thêm các điều khoản khác cần thảo luận"></textarea>
                        </div>
                        ...
                        <div class="negotiation-chat" style="margin-bottom: 40px;">
                            ...
                            <div class="chat-input">
                                <textarea class="form-control" id="chat-message"
                                          placeholder="Nhập tin nhắn thảo luận..."></textarea>
                ...
                <div class="contract-section" id="preview-section" style="display: none;">
                    ...
                    <div class="contract-preview">
                        <div class="alert alert-success">
                            <p><i class="fas fa-check-circle"></i> Hợp đồng đã được tạo từ các điều khoản đã thỏa thuận.
                                Vui lòng xem lại chi tiết trước khi ký kết.</p>
                        </div>
                ...
                <div class="contract-section" id="signing-section" style="display: none;">
                    ...
                    <div class="form-group">
                        <label class="form-label">
                            <input type="checkbox" required id="terms-agreement"> Tôi đã đọc và đồng ý với các điều
