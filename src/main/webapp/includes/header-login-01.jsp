...
<%--Header khi ở các trang khác khi đã đăng nhập--%>
                    ...
                    <div class="header-btn d-none d-lg-block">
                        <div class="user-card"
                            ...
                            <div style="flex: 1; text-align: center;">
                                <h2 id="user-name" style="color: #4a6375; font-size: 18px; font-weight: 00; margin: 0">Nguyễn Văn A</h2>
                                <p id="user-score" style="color: #4a6375; font-size: 14px; margin: 0;">Điểm: 100</p>
                            </div>
