...
<link rel='stylesheet' id='prolancer-fonts-css' href='https://fonts.googleapis.com/css?family=Inter%3A300%2C400%2C500%2C700%2C900&amp;subset=latin%2Clatin-ext&amp;display=fallback&amp;ver=6.7.1' type='text/css' media='all' />
...
<style>
    .my-auto01 img {
        ...
        height: 100px; /* Đảm bảo ảnh không bị méo */
        border-radius: 50%; /* Làm tròn khung ảnh */
        object-fit: cover; /* Giữ tỉ lệ ảnh và không bị méo */
        border: 3px solid #ddd; /* Viền nhẹ cho ảnh */
...
<style>
    ...
    .custom-badge {
        ...
        padding: 5px 10px; /* Kích thước badge lớn hơn */
        border-radius: 8px;
        border: 1px solid;
        display: inline-block;
...
<header id="site-header" style="width: 100%; padding: 10px 0; transition: all 0.3s ease; background-color: white;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-2 col-md-3 my-auto">
                    <div class="logo">
                        <a href="home" rel="home" aria-current="page"><img width="80" height="71" src="wp-content/uploads/2021/09/logo.png" class="custom-logo" alt="JobTrans" decoding="async" srcset="" sizes="(max-width: 500px) 100vw, 500px" /></a>		                    </div>
                </div>
                    ...
                    <div class="primary-menu d-none d-lg-inline-block">
                        <nav class="desktop-menu" >
                            <ul id="menu-primary" class="menu"><li id="menu-item-2318" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-2316 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-2318"><a  href="index.html">Trang chủ</a></li>
                                ...
                                <li id="menu-item-382" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-382"><a  href="about-me.jsp">Về chúng tôi</a></li>
                            </ul>	                        </nav>
                    </div>
                </div>
                <%
                    ...
                    <div class="header-btn d-none d-lg-block">
                        <div class="user-card"
                            ...
                            <div style="flex: 1; text-align: center;">
                                <h2 id="user-name" style="color: #4a6375; font-size: 18px; font-weight: 00; margin: 0"><%=account.getAccountName()%></h2>
                                <p id="user-score" style="color: #4a6375; font-size: 14px; margin: 0;">Điểm: <%=account.getPoint()%></p>
                            </div>
