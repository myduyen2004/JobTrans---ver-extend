                    ...
                    <div class="col-md-9">
                        <div class="form-section animate__animated animate__fadeInRight animate__delay-1s">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="date" class="form-control" id="dateOfBirth" name="dateOfBirth" value="${member.dateOfBirth}">
                        ...
                        <div class="form-section animate__animated animate__fadeInRight animate__delay-2s">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="number" class="form-control" id="experienceYears" name="experienceYears" value="${member.experienceYears}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" id="skills" name="skills" style="height: 100px" value="${member.skills}"></textarea>
...
<%--                                </div>--%>
                        ...
                        <div class="form-section animate__animated animate__fadeInRight animate__delay-3s">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" id="bio" style="height: 120px" name="bio" value="${member.bio}"></textarea>
