                    ...
                    <div class="col-md-12 my-auto">
                        ...
                        <ul class="trail-items" itemscope itemtype="http://schema.org/BreadcrumbList">
                            <li class="trail-item trail-begin"><a href="../index.html"><span
                                    itemprop="name">Thông tin cá nhân</span></a>
                                <meta itemprop="position" content="1" />
                            </li>
                            <li class="trail-item trail-end"><span itemprop="item"><span
                                    itemprop="name">Chỉnh sửa</span></span>
            ...
            <form>
                <div class="justify-content-center col-xl-12" style="display: flex;">
                    <div class="profile col-xl-4">
                        <img class="avatar" src="../wp-content/uploads/2021/04/pexels-andrea-piacquadio-874158-200x200.jpg" alt="Avatar">
                        <div class="stars">
                            <span>★★★★★</span>
                        </div>
                        <button class="avatar-btn">Thay avatar</button>
                        <p class="member-since">Thành viên từ .....</p>
                    </div>
                    <div class="info col-xl-6">
                        <h2 style="margin-bottom: 20px;">Thông tin cơ bản</h2>
                        <div class="info-grid" style="display: grid; grid-template-columns: 1fr 2fr; gap: 10px;">
                            <label for="full-name">Họ và tên</label>
                            <input type="text" id="full-name" name="full_name" value="Nguyễn Văn A" style="padding: 5px;">

                            <label for="dob">Ngày, tháng, năm sinh</label>
                            <input type="date" id="dob" name="dob" value="2002-02-22" style="padding: 5px;">

                            <label for="account-type">Loại tài khoản</label>
                            <input type="text" id="account-type" name="account_type" value="Cá nhân" style="padding: 5px;">
                            ...
                            <input type="text" id="specialization" name="specialization" value="IT, CNTT" style="padding: 5px;">

                            <label for="reputation-score">Điểm uy tín</label>
                            <input type="number" id="reputation-score" name="reputation_score" value="100" style="padding: 5px;">

                            <label for="balance">Số dư</label>
                            <input type="text" id="balance" name="balance" value="3.000.000 VNĐ" style="padding: 5px;">

                            <label for="email">Email</label>
                            <input type="email" id="email" name="email" value="ngva@gmail.com" style="padding: 5px;">

                            <label for="phone">SĐT</label>
                            <input type="tel" id="phone" name="phone" value="099999999" style="padding: 5px;">
                        </div>
                    </div>
                    <div class="buttons col-xl-2">
                        <button type="submit" class="edit-btn">Lưu thông tin</button>
