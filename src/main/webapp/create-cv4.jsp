...
<script>
  ...
  function updateTextColor(bgColor) {
    ...
    const brightness = calculateBrightness(bgColor || '#7a785c');
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    const savedColor = localStorage.getItem('cvBackgroundColor') || '#7a785c';
