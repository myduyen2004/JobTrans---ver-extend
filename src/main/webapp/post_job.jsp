    ...
    <form class="p-6" action="job" method="post" enctype="multipart/form-data">
        ...
        <div style="padding-left: 20px; padding-right: 20px">
            <div class="mb-4 form-group">
                ...
                <input id="title" name="title" class="px-2 py-2" type="text"/>
            </div>
            ...
            <div class="d-flex  mb-4 form-group">
                ...
                <input id="numOfMems" name="numOfMems" class="px-2 py-2" type="number"/>
            </div>
            <div class="d-flex mb-4 form-group">
            ...
            <div class="mb-4 flex space-x-4">
                <div class="d-flex form-group">
                    ...
                    <div class="flex space-x-2">
                        ...
                        <input class="px-2 py-2 text-center" name="budgetMin" style="margin-right: 50px;" type="text"
                               value="0"/>
                        <input class="px-2 py-2 max text-center" placeholder="MAX" type="text" value="MAX"/>
                        <input class="px-2 py-2 text-center" name="budgetMax" type="text" value="0"/>
                    </div>
                </div>
            </div>
            <div class="d-flex mb-4 form-group">
            ...
            <div class="flex space-x-4 justify-content-center">
                <input class="w-1/4 px-4 py-2 text-white" type="submit"
                       style="background-color: #6787FE; border: solid 1px #6787FE; border-radius: 50px; flex: none;" value="Đăng tin tuyển dụng"/>
