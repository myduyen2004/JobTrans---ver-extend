...
<section class="section-padding">
	<div class="container">
		...
		<div  class="search-result col-xl-9">
				        <div style="border: 5px rgba(103, 135, 254, 0.50) solid"  class="prolancer-project-item style-2">
                            
                        <div class="row"> 
                <div  class="col-md-2 my-auto">
                    <i class="fad fa-signal-alt-3 fa-2x"></i>
                </div>
                <div class="col-md-7 my-auto">
                   <a class="project-title" href="english-content-writer-for-fintech/index.html"><h4>DANH SÁCH CÔNG VIỆC ĐÃ ĐĂNG</h4></a>
                   
                </div>
                <div  class="col-md-3 my-auto">
                   <a style="border-radius: 20px" href="english-content-writer-for-fintech/index.html" class="prolancer-rgb-btn float-lg-end">Quản lí</a>
                </div>
            </div>
        </div>
            <div style="border: 5px  rgba(103, 135, 254, 0.50) solid" class="prolancer-project-item style-2">
                ...
                <div class="col-md-7 my-auto">
                   <a class="project-title" href="swift-swiftui-developer-for-b2b-ios-apps/index.html"><h4>DANH SÁCH CÔNG VIỆC ĐÃ ỨNG TUYỂN</h4></a>
                </div>

                <div class="col-md-3 my-auto">
                   <a href="swift-swiftui-developer-for-b2b-ios-apps/index.html" class="prolancer-rgb-btn float-lg-end">Quản lí</a>
                </div>
            </div>
        </div>
