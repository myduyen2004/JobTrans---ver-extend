...
<head>
    ...
    <link href="css/report_detail_1.css" rel="stylesheet">
</head>
...
<div class="text-center py-4 banner_title">
    <h1 class="h2 text-white font-weight-medium">Chi tiết tố cáo người dùng</h1>
</div>
...
<div class="container mt-5 p-4 ">
    ...
    <div class="mt-4">
        <table class="table table-bordered m-0 tb-1">
            <tr>
                <td class="font-weight-bold text-center">Tên dự án: Dịch tiếng Hàn</td>
            </tr>
        </table>
        <table class="table table-bordered m-0">
            <tr>
                <td class="text-center">Người tố cáo: Vu</td>
                <td>Vi phạm nội dung: </td>
            </tr>
        </table>
        <table class="table table-bordered m-0 tb-3">
            <tr>
                <td class="font-weight-bold text-center">Nội dung chi tiết báo cáo</td>
            </tr>
            <tr>
                <td>
                    <br></br>
    ...
    <div class="mt-5 d-flex justify-content-end">
        <a href="#" class="mr-4 report-user text-center pt-1">Tố cáo người dùng</a>
