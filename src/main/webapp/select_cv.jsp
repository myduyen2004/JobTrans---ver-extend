...
<body class="archive post-type-archive post-type-archive-projects wp-custom-logo theme-prolancer woocommerce-no-js elementor-default elementor-kit-1806">
 ...
 <div class="cv-container">
        ...
        <div class="cv-card">
            <img src="cv1.jpg" alt="CV Cổ điển" class="cv-image">
            <div class="cv-info">
                   <div style="display: flex">
                <p class="cv-description">Thiết kế CV cổ điển, đầy đủ, chuyên nghiệp</p>
                <span class="cv-price free">Free</span>
                   </div>
                <div class="button-group">
                    <button class="view-btn">Xem mẫu</button>
     ...
     <div class="cv-card">
    <img src="cv2.jpg" alt="CV Hiện đại" class="cv-image">
    <div class="cv-info">
        <div class="cv-header">
            <p class="cv-description">Thiết kế CV hiện đại, chuyên nghiệp</p>
            <span class="cv-price">10 xu</span>
        </div>
        <div class="button-group">
            <button class="view-btn">Xem mẫu</button>
            <button class="use-btn">Sử dụng</button>
