...
<head>
    <meta charset="UTF-8">
    <title>Login and register &#8211; ProLancer</title>
                ...
                <div class="elementor-widget-wrap elementor-element-populated">
                    <div class="elementor-element elementor-element-5b8fa5a elementor-widget elementor-widget-heading" data-id="5b8fa5a" data-element_type="widget" data-widget_type="heading.default">
                        <div class="elementor-widget-container">
                            <h2 class="elementor-heading-title elementor-size-default">Welcome to ProLancer</h2>				</div>
                    </div>
                    <div class="elementor-element elementor-element-ac27cf7 elementor-widget elementor-widget-heading" data-id="ac27cf7" data-element_type="widget" data-widget_type="heading.default">
                        <div class="elementor-widget-container">
                            <h2 class="elementor-heading-title elementor-size-default">Work with talented people at the most affordable price to get the most out of your time and cost
                    ...
                    <div class="elementor-element elementor-element-761afa1 elementor-widget elementor-widget-login_and_register" data-id="761afa1" data-element_type="widget" data-widget_type="login_and_register.default">
                        <div class="elementor-widget-container">
                            <div class="login-and-register">
                                <a href="../index.html" class="custom-logo-link" rel="home"><img decoding="async" width="500" height="71" src="../wp-content/uploads/2021/09/logo.png" class="custom-logo" alt="ProLancer" srcset="https://themebing.com/wp/prolancer/wp-content/uploads/2021/09/logo.png 500w, https://themebing.com/wp/prolancer/wp-content/uploads/2021/09/logo-300x43.png 300w" sizes="(max-width: 500px) 100vw, 500px" /></a>         <nav class="mb-3">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="login" role="tabpanel">
                                        <form id="login-form">
                                            ...
                                            <a href="#" id="login-submit" data-nonce="b341788b2c" class="prolancer-btn">Login</a>
                                        </form>
                                        <a href="../wp-loginc2b6.html?action=lostpassword" class="mt-4 pt-2 d-block lost-password" alt="Lost password">
                                            Lost password               </a>
                                    </div>
                                    <div class="tab-pane fade" id="register" role="tabpanel">
                                        <form id="register-form">
                                            ...
                                            <a href="#" id="register-submit" data-nonce="054bcfec78" class="prolancer-btn">Register</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
