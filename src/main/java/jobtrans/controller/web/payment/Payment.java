...
//        Wallet wallet = walletDao.getWallet(username);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("amount-add", request.getParameter("amount"));
        ...
        if ("success".equalsIgnoreCase(message)) {
            out.print("Chuỗi JSON chứa 'success'");
        } else {
            out.print("Chuỗi JSON không chứa 'success'");
        }
//        Transaction trans = new Transaction();
//        trans.setSenderId(u.getUserId());
//        trans.setAmount(Double.parseDouble(request.getParameter("amount")));
//        trans.setStatus(true);
//        trans.setTransactionType("Nộp tiền");
//        trans.setDescription("Nộp tiền vào ví");
//
//        transactionDao.addTransaction(trans);
//        transactionDao.updateBalance(u);
