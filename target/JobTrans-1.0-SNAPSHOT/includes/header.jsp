...
<li id="menu-item-27" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-27"><a  href="services/index.jsp">Tạo CV</a>
</li>
...
<li id="menu-item-382" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-382"><a  href="about/index.jsp">Về chúng tôi</a></li>
                        ...
                        <div class="col-xl-2 col-md-2 my-auto">
                            <div class="header-btn d-none d-lg-block">
                                <a href="login-and-register/index.jsp">
                                    Đăng nhập	                        </a>
                            </div>
                        </div> 
