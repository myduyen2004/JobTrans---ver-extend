...
--%>
<%--Header dành cho lúc đã đăng nhập khi đứng ở trang chủ--%>
...
<header id="site-header" style="position: fixed; width: 100%; padding: 10px 0; transition: all 0.3s ease;">
                    ...
                    <div class="header-btn d-none d-lg-block">
                        <div class="user-card"
                            ...
                            <div style="flex: 1; text-align: center;">
                                <h2 id="user-name" style="color: white; font-size: 18px; font-weight: bold; margin: 0;">Nguyễn Văn A</h2>
                                <p id="user-score" style="color: white; font-size: 14px; margin: 0;">Điểm: 100</p>
                            </div>
