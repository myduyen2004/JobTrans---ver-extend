...
=======
>>>>>>> c40189113155e7d471a5c4bdb527334f9030059e
...
<head>
    ...
    <link rel="alternate" type="application/rss+xml" title="ProLancer &raquo; Projects Feed" href="feed/index.html" />
    ...
    <link rel='stylesheet' id='wp-block-library-css'
        href='../wp-includes/css/dist/block-library/style.min9704.css?ver=6.7.1' type='text/css' media='all' />
    ...
    <link rel='stylesheet' id='prolancer-select2-css'
        href='../wp-content/plugins/prolancer-element/assets/css/select2.min9704.css?ver=6.7.1' type='text/css'
        media='all' />
    <link rel='stylesheet' id='prolancer-dashboard-css'
        href='../wp-content/plugins/prolancer-element/assets/css/dashboard9704.css?ver=6.7.1' type='text/css'
        media='all' />
    <link rel='stylesheet' id='slick-theme-css'
        href='../wp-content/plugins/prolancer-element/assets/css/slick-theme9704.css?ver=6.7.1' type='text/css'
        media='all' />
    <link rel='stylesheet' id='prolancer-plugins-css'
        href='../wp-content/plugins/prolancer-element/assets/css/plugins9704.css?ver=6.7.1' type='text/css'
        media='all' />
    <link rel='stylesheet' id='prolancer-plugin-css'
        href='../wp-content/plugins/prolancer-element/assets/css/plugin9704-quang.css' type='text/css' media='all' />
    <link rel='stylesheet' id='prolancer-mega-menu-css'
        href='../wp-content/plugins/prolancer-element/inc/mega-menu/assets/css/mega-menu9704.css?ver=6.7.1'
    ...
    <link rel='stylesheet' id='animate-css'
        href='../wp-content/themes/prolancer/assets/css/animate.min9704.css?ver=6.7.1' type='text/css' media='all' />
    ...
    <link rel='stylesheet' id='magnific-popup-css'
        href='../wp-content/themes/prolancer/assets/css/magnific-popup.min9704.css?ver=6.7.1' type='text/css'
        media='all' />
    <link rel='stylesheet' id='fontawesome-css'
        href='../wp-content/themes/prolancer/assets/css/fontawesome.min9704.css?ver=6.7.1' type='text/css'
        media='all' />
    <link rel='stylesheet' id='bootstrap-css'
        href='../wp-content/themes/prolancer/assets/css/bootstrap.min9704.css?ver=6.7.1' type='text/css' media='all' />
    ...
    <style id='prolancer-style-inline-css' type='text/css'>
        ...
        .sellers .slick-arrow.fa-chevron-left,
        .sellers .slick-arrow.fa-chevron-right,
        .buyers .slick-arrow.fa-chevron-left,
        .buyers .slick-arrow.fa-chevron-right,
        .services .slick-arrow.fa-chevron-left,
        .services .slick-arrow.fa-chevron-right,
        .projects .slick-arrow.fa-chevron-left,
        .projects .slick-arrow.fa-chevron-right,
        ...
        .prolancer-pricing-table.recommended,
        .prolancer-pricing-table a:hover,
        ...
        .stats .col-lg-3:nth-child(1) .dashboard-stats-item,
        ...
        .buyer-profile ul.meta li:nth-child(2),
        ...
        .frontend-dashboard-header .balance-in-navbar,
        .widget .seller-detail:nth-child(4) i,
        ...
        .widget .seller-detail:nth-child(5) i,
        ...
        .prolancer-service-item.style-2 .slick-dots li button:before,
        .header-btn a,
        .prolancer-service-item.style-1 .service-price h4,
        ...
        .nav-tabs .nav-item.show .nav-link,
        .nav-tabs .nav-link.active,
        .banner.style-2 .banner-content h1 span,
        .client-info h4,
        ...
        .message_receiver .download,
        .page-template-custom-page-without-breadcrumb .site-header.fixed-top .header-btn a,
        .header-btn a,
        .dropzone.is-dragover,
        .irs--round .irs-handle,
        .prolancer-project-item.style-1:hover,
    ...
    <link rel="preload" as="style"
        href="https://fonts.googleapis.com/css?family=Poppins:700%7CRubik&amp;display=swap&amp;ver=1735374379" />
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Poppins:700%7CRubik&amp;display=swap&amp;ver=1735374379"
    ...
    <script type="text/javascript"
        src="../wp-content/plugins/woocommerce/assets/js/frontend/woocommerce.min0c46.js?ver=9.5.1" id="woocommerce-js"
    ...
    <meta name="generator" content="Redux 4.5.4" /> <noscript>
        <style>
                            ...
                            <nav class="desktop-menu">
                                <ul id="menu-primary" class="menu">
                                    <li id="menu-item-2318"
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-has-children menu-item-2318">
                                        <a href="../index.html">Home</a>
                                        <ul class="sub-menu">
                                            <li id="menu-item-3045"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-3045">
                                                <a href="../index.html" class="dropdown-mega-menu-toggle">Home 1</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                            <li id="menu-item-3044"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3044">
                                                <a href="../home-2/index.html" class="dropdown-mega-menu-toggle">Home
                                                    2</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                            <li id="menu-item-3043"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3043">
                                                <a href="../home-3/index.html" class="dropdown-mega-menu-toggle">Home
                                                    3</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                            <li id="menu-item-3042"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3042">
                                                <a href="../home-4/index.html" class="dropdown-mega-menu-toggle">Home
                                                    4</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                        </ul>
                                    ...
                                    <li id="menu-item-26"
                                        class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-26">
                                        <a href="index.html">Browse Jobs</a>
                                        <ul class="sub-menu">
                                            <li id="menu-item-718"
                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-718">
                                                <a href="index.html" class="dropdown-mega-menu-toggle">Project Right
                                                    Sidebar</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                            <li id="menu-item-391"
                                                class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-391">
                                                <a href="index95ca.html?projects-layout=projects_left_sidebar"
                                                    class="dropdown-mega-menu-toggle">Project Left Sidebar</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                            <li id="menu-item-716"
                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-716">
                                                <a href="index1399.html?projects-layout=projects_fullwidth"
                                                    class="dropdown-mega-menu-toggle">Project Full Width</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                            <li id="menu-item-390"
                                                class="menu-item menu-item-type-post_type menu-item-object-projects menu-item-390">
                                                <a href="graphic-designer-for-ongoing-job/index.html"
                                                    class="dropdown-mega-menu-toggle">Project Details</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                        </ul>
                                    </li>
                                    <li id="menu-item-27"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-27">
                                        <a href="../services/index.html">Services</a>
                                        <ul class="sub-menu">
                                            <li id="menu-item-392"
                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-392">
                                                <a href="../services/index.html"
                                                    class="dropdown-mega-menu-toggle">Service Right Sidebar</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                            <li id="menu-item-714"
                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-714">
                                                <a href="../services/index2efa.html?services-layout=services_left_sidebar"
                                                    class="dropdown-mega-menu-toggle">Service Left Sidebar</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                            <li id="menu-item-715"
                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-715">
                                                <a href="../services/index886d.html?services-layout=services_fullwidth"
                                                    class="dropdown-mega-menu-toggle">Service Full Width</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                            <li id="menu-item-389"
                                                class="menu-item menu-item-type-post_type menu-item-object-services menu-item-389">
                                                <a href="../services/i-will-be-your-android-app-developer-for-android-app-development/index.html"
                                                    class="dropdown-mega-menu-toggle">Service Details</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                        </ul>
                                    </li>
                                    <li id="menu-item-20"
                                        class="menu-item menu-item-type-post_type menu-item-object-page current_page_parent menu-item-has-children menu-item-20">
                                        <a href="../blog/index.html">Blog</a>
                                        <ul class="sub-menu">
                                            <li id="menu-item-386"
                                                class="menu-item menu-item-type-post_type menu-item-object-page current_page_parent menu-item-386">
                                                <a href="../blog/index.html" class="dropdown-mega-menu-toggle">Blog
                                                    Right Sidebar</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                            <li id="menu-item-724"
                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-724">
                                                <a href="../blog/index2727.html?blog-layout=blog_left_sidebar"
                                                    class="dropdown-mega-menu-toggle">Blog Left Sidebar</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                            <li id="menu-item-725"
                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-725">
                                                <a href="../blog/index225c.html?blog-layout=blog_fullwidth"
                                                    class="dropdown-mega-menu-toggle">Blog Full Width</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                            <li id="menu-item-385"
                                                class="menu-item menu-item-type-post_type menu-item-object-post menu-item-385">
                                                <a href="../can-i-make-a-career-out-of-freelancing/index.html"
                                                    class="dropdown-mega-menu-toggle">Post Details</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li id="menu-item-373"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-373">
                                        <a href="#">Pages</a>
                                        <ul class="sub-menu">
                                            <li id="menu-item-37"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-37">
                                                <a href="../how-it-works/index.html"
                                                    class="dropdown-mega-menu-toggle">How it works</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                            <li id="menu-item-3720"
                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3720">
                                                <a href="../buyers/index.html"
                                                    class="dropdown-mega-menu-toggle">Buyers</a>
                                                <div class="mega-menu-content"></div>
                                                <ul class="sub-menu">
                                                    <li id="menu-item-393"
                                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-393">
                                                        <a href="../buyers/index.html"
                                                            class="dropdown-mega-menu-toggle">Buyer Right Sidebar</a>
                                                        <div class="mega-menu-content"></div>
                                                    </li>
                                                    <li id="menu-item-720"
                                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-720">
                                                        <a href="../buyers/indexdd5d.html?buyers-layout=buyers_left_sidebar"
                                                            class="dropdown-mega-menu-toggle">Buyer Left Sidebar</a>
                                                        <div class="mega-menu-content"></div>
                                                    </li>
                                                    <li id="menu-item-721"
                                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-721">
                                                        <a href="../buyers/index001a.html?buyers-layout=buyers_fullwidth"
                                                            class="dropdown-mega-menu-toggle">Buyer Full Width</a>
                                                        <div class="mega-menu-content"></div>
                                                    </li>
                                                    <li id="menu-item-388"
                                                        class="menu-item menu-item-type-post_type menu-item-object-buyers menu-item-388">
                                                        <a href="../buyers/harry-olson/index.html"
                                                            class="dropdown-mega-menu-toggle">Buyer Details</a>
                                                        <div class="mega-menu-content"></div>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li id="menu-item-3721"
                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3721">
                                                <a href="../sellers/index.html"
                                                    class="dropdown-mega-menu-toggle">Sellers</a>
                                                <div class="mega-menu-content"></div>
                                                <ul class="sub-menu">
                                                    <li id="menu-item-394"
                                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-394">
                                                        <a href="../sellers/index.html"
                                                            class="dropdown-mega-menu-toggle">Seller Right Sidebar</a>
                                                        <div class="mega-menu-content"></div>
                                                    </li>
                                                    <li id="menu-item-722"
                                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-722">
                                                        <a href="../sellers/index7e1e.html?sellers-layout=sellers_left_sidebar"
                                                            class="dropdown-mega-menu-toggle">Seller Left Sidebar</a>
                                                        <div class="mega-menu-content"></div>
                                                    </li>
                                                    <li id="menu-item-723"
                                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-723">
                                                        <a href="../sellers/index5fbc.html?sellers-layout=sellers_full_width"
                                                            class="dropdown-mega-menu-toggle">Seller Full Width</a>
                                                        <div class="mega-menu-content"></div>
                                                    </li>
                                                    <li id="menu-item-387"
                                                        class="menu-item menu-item-type-post_type menu-item-object-sellers menu-item-387">
                                                        <a href="../sellers/david-parker/index.html"
                                                            class="dropdown-mega-menu-toggle">Seller Details</a>
                                                        <div class="mega-menu-content"></div>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li id="menu-item-376"
                                                ...
                                                <a href="../faq/index.html" class="dropdown-mega-menu-toggle">FAQ</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                            <li id="menu-item-380"
                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-380">
                                                <a href="../404.html" class="dropdown-mega-menu-toggle">404</a>
                                                <div class="mega-menu-content"></div>
                                            </li>
                                        </ul>
                                    </li>
            ...
            <div class="row justify-content-center flex-row-reverse col-xl-12">
                ...
                <div class="col-xl-3 position-relative">
                    <aside id="secondary" class="widget-area">
                        <div id="prolancer_filter_by_attribute-2" class="widget widget_prolancer_filter_by_attribute">
                            <h4 class="widget-title">Filter by Attribute</h4>
                            <form id="project-search-form" enctype="multipart/form-data" data-nonce="112e646a38">

                                <div class="filter-box">
                                    <label>Price</label>
                                    <div class="price-range" data-max-value="2000"></div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6"><input type="number"
                                                class="from-price form-control text-center" name="price-from" disabled>
                                        </div>
                                        <div class="col-sm-6"><input type="number"
                                                class="to-price form-control text-center" name="price-to" disabled>
                                        </div>
                                    </div>
                                </div>

                                <!-- Pop-up Äá»i máº­t kháº©u -->
                                <a href="#" class="btn-change-password">Äá»i máº­t kháº©u</a>

                                <div class="modal-overlay" id="modal">
                                    <div class="modal-container">
                                        <div class="modal-header">
                                            <p class="modal-description">
                                                Nguyá»n VÄn User | JOBTRANS
                                            </p>
                                            <span class="modal-title">Äá»i máº­t kháº©u</span>
                                            <p class="modal-description">
                                                Máº­t kháº©u cá»§a báº¡n pháº£i cÃ³ tá»i thiá»u 8 kÃ½ tá»±, Äá»ng thá»i bao gá»m cáº£ chá»¯ sá»,
                                                chá»¯ cÃ¡i in hoa.
                                            </p>
                                            <button class="modal-close" id="close-modal">&times;</button>
                                        </div>
                                        <div>
                                            <input type="password" class="modal-input" placeholder="Máº­t kháº©u hiá»n táº¡i"
                                                autocomplete="off">
                                            <input type="password" class="highlight-input" placeholder="Máº­t kháº©u má»i"
                                                autocomplete="off">
                                            <input type="password" class="modal-input" placeholder="Nháº­p láº¡i máº­t kháº©u"
                                                autocomplete="off">
                                        </div>
                                        <div style="text-align: center;">
                                            <input type="submit" class="modal-button" value="XÃ¡c nháº­n">
                                        </div>
                                    </div>
                                </div>
                        </div>
