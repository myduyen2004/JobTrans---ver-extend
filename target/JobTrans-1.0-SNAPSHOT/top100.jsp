   ...
   <div class="container_top100" id="back-to-top">
        ...
        <div class="freelancer">
            ...
            <div class="profile">
                ...
                <div>
                    <div class="name">Devis Huy</div>
                    <div class="stars">★★★★★</div>
                </div>
            </div>
            <div class="score">278</div>
        </div>
        <div class="freelancer">
            ...
            <div class="profile">
                ...
                <div>
                    <div class="name">Công HuHu</div>
                    <div class="stars">★★★★★</div>
                </div>
            </div>
            <div class="score">208</div>
        </div>
        <div class="freelancer">
            ...
            <div class="profile">
                ...
                <div>
                    <div class="name">Quang ke</div>
                    <div class="stars">★★★★★</div>
                </div>
            </div>
            <div class="score">178</div>
        </div>
        <div class="freelancer">
